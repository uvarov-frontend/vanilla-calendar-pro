...
- `cypress/e2e/workbench.cy.ts`: development-site navigation and search, source highlighting and preview state, instance inspector, theme persistence, source colors in both themes, case anchors, and mobile navigation/focus.
