...
## JS
Если вы установили VanillaCalendar с помощью NPM или Yarn, вам нужно импортировать JavaScript и необходимые стили. Если вы использовали CDN или включили JavaScript и стили в `<head>`, вы можете пропустить этот шаг.
