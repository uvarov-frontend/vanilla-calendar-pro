...
## Пробный запуск VanillaCalendar
...
## Установка с использованием NPM или Yarn

Вы можете установить VanillaCalendar с помощью NPM или Yarn, если вы используете сборщик модулей в своем проекте.
