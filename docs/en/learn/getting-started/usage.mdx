...
<Info>
  In addition to the file **«vanilla-calendar.min.css»**, which contains all possible calendar styles, there are separate style files in the **«build»**
  directory. Please include them instead of **«vanilla-calendar.min.css»** if you find it necessary.
</Info>
...
<Info>
  The calendar automatically displays the theme used in the user's system. You can disable this default behavior and forcibly set any of the themes. In this
  case, you don't need to import all the themes.
</Info>
