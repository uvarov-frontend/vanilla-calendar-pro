...
<Info>
  If your language tag is supported by the{' '}
  ...
  method, you can pass that language tag to the `settings.lang` parameter without the need for manual localization. You can find information about your language
  tag support{' '}
