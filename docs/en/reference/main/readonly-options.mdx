...
The currently selected hour. Available if `settings.selection.time` is not `false`.
...
The currently selected minutes. Available if `settings.selection.time` is not `false`.
...
Current AM/PM marker for 12-hour time format. Available if `settings.selection.time` is not `false`.
...
Current full time. Available if `settings.selection.time` is not `false`.
