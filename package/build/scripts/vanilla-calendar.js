/*! name: vanilla-calendar-pro v3.0.0-beta.2 | url: https://github.com/uvarov-frontend/vanilla-calendar-pro */
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.VanillaCalendar = factory());
})(this, function() {
...
`;
  ...
  const createMonthEl = (self2, templateEl, selected, titleShort, titleLong, disabled, i) => {
...
`;
  ...
  const createTime = (self2) => {
    ...
    <div class="${self2.styles.timeContent}" data-vc-time="content">
      ${TimeInput("hour", self2.styles.timeHour, self2.labels, valueHours, range)}
  ...
  const createYearEl = (self2, templateEl, selected, disabled, i) => {
  ...
  const initTime = (self2) => {
    ...
    if (!hours) {
      ...
      keeping = isTime12 && Number(transformTime12(String(self2.timeMinHour))) >= 12 ? "PM" : "AM";
  ...
  const update = (self2, { year, month, dates, time, locale } = {}) => {
    if (!self2.private.isInit)
      throw new Error(errorMessages.notInit);
    if (self2.isInput && !self2.private.isInputInit)
      createToInput(self2, false);
    reset(self2, { year, month, dates, time, locale });
    if (self2.onUpdate)
