...
// 	const days: HTMLDivElement | null = (e.target as HTMLElement).closest('[data-vc="days"]');
...
const handleDateRangedSelection = (self: VanillaCalendar, formattedDate?: FormatDateString) => {
	// if (formattedDate) {
...
export default handleDateRangedSelection;
